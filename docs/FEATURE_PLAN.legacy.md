...
> 详细设计已归档至 [ARCHIVED_FEATURES.md §二十八 全场景会话恢复统一闭包](./ARCHIVED_FEATURES.md#三十一全场景会话恢复统一闭包f-49-phase-04----session-resume-统一)
...
> 详细设计（会话格式分层参考图、resume 能力矩阵）已归档至 [ARCHIVED_FEATURES.md §二十九 会话格式分层参考图](./ARCHIVED_FEATURES.md#三十二会话格式分层参考图全场景一览f-49-)
...
> 详细设计（问题现状三文件冗余、文件格式规范、改造点清单、向后兼容策略、方案对比验证、验收标准）已归档至 [ARCHIVED_FEATURES.md §三十 session.json + transcript.jsonl 合并](./ARCHIVED_FEATURES.md#三十三sessionjson--transcriptjsonl-合并f-49-e-)
...
> 详细设计（问题现状、核心设计 parentUuid/walkChainBeforeParse/buildConversationChain、改造点清单 P103-A~J、验收标准、风险与约束、设计决定、依赖与协同）已归档至 [ARCHIVED_FEATURES.md §三十一 parentUuid 链](./ARCHIVED_FEATURES.md#三十四parentuuid-链--walkchainbeforeparse-读取过滤f-103-)
...
> ✅ 详细设计（统计命令示例、数据清理、实时查询、Transcript 方案、工具裁剪策略、SOP 转化模式、业务 Agent 长期使用）已归档至 [ARCHIVED_FEATURES.md §三十五 F-75 工具/Skill 调用统计](./ARCHIVED_FEATURES.md#三十五f-75-工具skill-调用统计跨会话)
...
> **F-87（Workflow Scripts）** 已被 **声明式工作流引擎（F-1.10）** 和 **SOP 工作流模式（F-50.10~）** 取代。原详细设计已归档至 [ARCHIVED_FEATURES.md §36 F-87](./ARCHIVED_FEATURES.md#三十六F-87workflow scripts 工作流脚本)
...
### 10.1 Community Radar — 候选特性抽取与报告系统（F-91 ✅）

> ✅ F-91 Community Radar 已完整实现，详细设计（候选特性抽取与分类、评分与报告系统、Cron 集成、三方集成组件、协同分析、文件结构、实施阶段、验收标准、风险与约束、设计决定、依赖与协同）已归档至 [ARCHIVED_FEATURES.md §37 F-91 Community Radar](./ARCHIVED_FEATURES.md#三十七f-91-community-radar-候选特性分析与报告系统)
