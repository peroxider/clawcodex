...
#### 概述
ProgressReporter Sink 重构 已实现并归档。
...
#### 概述
ExecuteExtraTool 延迟工具系统 处于设计阶段。
...
#### 概述
Auto 模式 (TRANSCRIPT_CLASSIFIER) 已实现并归档。
...
#### 概述
Permission Settings Schema 重构设计 已实现并归档。
...
#### 概述
Sandbox / SSH Remote 沙箱远程执行 处于设计阶段。
