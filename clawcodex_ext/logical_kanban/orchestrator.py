...
def task_ready_state(context: "ToolContext", task_id: str) -> dict[str, Any]:
...
def task_list_summary(context: "ToolContext") -> list[dict[str, Any]]:
...
def latest_denial_for_task(context: "ToolContext", task_id: str) -> dict[str, Any] | None:
...
def acceptance_proof_required(context: "ToolContext", task_id: str) -> bool:
