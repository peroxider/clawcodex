...
READONLY_COMMANDS: frozenset[str] = frozenset(
    [
        # POSIX commands
        "cat", "head", "tail", "wc", "stat", "strings", "hexdump", "od",
        "nl", "ls", "tree", "du", "exa", "eza",
        "grep", "rg", "find", "fd", "fdfind", "ag", "ack", "locate",
        "diff", "comm", "cmp",
        "id", "uname", "free", "df", "locale", "groups", "nproc",
        "basename", "dirname", "realpath", "readlink",
        "cal", "uptime", "date", "cut", "paste", "tr", "column", "tac",
        "rev", "fold", "expand", "unexpand", "fmt", "numfmt", "sort", "uniq",
        "pwd", "whoami", "which", "type", "file",
        "git",
        "true", "false", "sleep", "echo", "printf", "expr", "test",
        "getconf", "seq", "jq",
        "ps", "pgrep", "lsof", "netstat", "ss",
        "sha256sum", "sha1sum", "md5sum", "base64",
        "man", "info", "help", "hostname", "tput",
    ]
)
