...
def _is_powershell_verb_noun(base: str) -> bool:
    ...
    return verb in (
        "get", "set", "new", "remove", "invoke", "write", "out",
        "clear", "export", "import", "add", "where", "select",
        "measure", "push", "pop", "rename", "start", "stop",
        "restart", "format", "convert", "compare", "group", "sort",
        "foreach", "find", "search", "read", "show", "dump",
        "wait", "disable", "enable", "register", "unregister",
        "mount", "dismount", "copy", "move", "join", "split",
        "resume", "suspend", "use", "complete", "enter", "exit",
        "lock", "unlock", "optimize", "repair", "reset", "resolve",
        "save", "switch", "sync", "test", "trace", "update",
    )
...
def _classify_pwsh_base(base: str) -> tuple[bool, bool, bool]:
    ...
    if "-" in b:
        ...
        if verb in ("get", "read", "show", "dump", "format", "compare", "group", "sort"):
            return (False, True, False)
        if verb in ("set", "new", "remove", "clear", "write", "out", "export", "import", "add",
                     "push", "pop", "rename", "copy", "move", "mount", "disable", "enable",
                     "register", "unregister", "start", "stop", "restart", "resume", "suspend",
                     "lock", "unlock", "save", "switch", "sync", "test"):
