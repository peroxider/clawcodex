---
# ---------------------------------------------------------------------------
# Tracker: GitCode (https://gitcode.com/chadwweng/project-test) master branch
# ---------------------------------------------------------------------------
tracker:
  kind: gitcode
  ...
  owner: chadwweng
  repo: project-test
  clone_url: https://gitcode.com/chadwweng/project-test.git
...
# ---------------------------------------------------------------------------
# Workspace: 克隆 project-test 仓库到本地,基于 master 拉分支处理 issue
# ---------------------------------------------------------------------------
workspace:
  root: /tmp/symphony_workspaces/project-test
  repo_clone_url: https://gitcode.com/chadwweng/project-test.git
  clone_depth: 1
...
**project-test** repository (https://gitcode.com/chadwweng/project-test). The issue has
...
2. Explore the project-test codebase as needed (Read, Grep, Glob, Bash).
...
**Coding conventions for project-test:**
