...
def _audit_log(context: Any) -> AuditLog:
...
class LogicalKanbanService:
    ...
    def snapshot(self, context: Any) -> FactsSnapshot:
        return build_facts_snapshot(context)

    def _augmented_snapshot(self, context: Any) -> FactsSnapshot:
    ...
    def propose(self, change: ProposedChange, context: Any) -> Proposal:
        snapshot = self.snapshot(context)
        proposal = Proposal(
    ...
    def validate(self, proposal: Proposal, context: Any) -> ValidationRun:
    ...
    def _emit_snapshot_metrics(self, context: Any) -> None:
    ...
    def _do_validate(self, proposal: Proposal, context: Any) -> ValidationRun:
    ...
    def _tms(self, context: Any) -> TruthMaintenanceSystem:
        tms = get_logical_kanban(context).tms
