...
from lkb.acceptance_template import (
    AcceptanceTemplate,
...
from lkb.acceptance_template_governance import (
...
from lkb.acceptance_template_prompt import (
    select_templates_by_goal,
    summarize_acceptance_templates,
)
from lkb.audit import InMemoryAuditLog
from lkb.decomposer import DecompositionPlan, ProposedTask
from lkb.external_config import ExternalConfigImporter
from lkb.external_config_lint import lint_acceptance_templates
from lkb.rule_engine import (
...
def test_audit_emits_template_referenced_event() -> None:
    from lkb.decomposer import TaskDecomposer
