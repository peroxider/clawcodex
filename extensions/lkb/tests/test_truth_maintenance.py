...
from lkb.context_adapter import task_lkb_view
from lkb.fuzzy_types import AssumptionSource
try:
...
try:
    ...
    TaskCreateTool = TaskGetTool = TaskListTool = TaskUpdateTool = None  # standalone lkb
