...
from lkb.ambiguity_detector import AmbiguityDetector
from lkb.commit_gate_fuzzy import (
    aggregate_world_results,
    commit_gate_fuzzy_check,
)
from lkb.fuzzy_patterns import (
    BUILT_IN_PATTERN_LIBRARY,
    FuzzyPattern,
)
from lkb.fuzzy_types import (
    Assumption,
    Clarification,
    Interpretation,
    WorldValidationResult,
)
from lkb.ir import make_canonical, pred
from lkb.multiworld_validator import MultiWorldValidator
from lkb.rule_engine import Layer1RuleEngine
from lkb.service import LogicalKanbanService
from lkb.types import ProposedChange
from lkb.world_generator import WorldGenerator
try:
    from clawcodex_ext.tool_system.context import ToolContext
except ImportError:
    ToolContext = None  # standalone lkb: ToolContext not available
...
class TestWorldGenerator:
    ...
    def test_domain_constraint_prunes_invalid_world(self) -> None:
        ...
        from lkb.fuzzy_patterns import DomainConstraint
...
class TestCommitGateFuzzy:
    def test_denies_low_confidence_assumption(self) -> None:
        ...
        from lkb.fuzzy_types import AmbiguityReport
    ...
    def test_denies_unresolved_critical_ambiguity(self) -> None:
        from lkb.fuzzy_types import Ambiguity, AmbiguityReport
