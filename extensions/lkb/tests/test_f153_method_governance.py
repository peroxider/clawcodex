...
from lkb.method_proposer import (
    _check_dag_no_cycle,
    _validate_proposed_method,
    propose_method_from_plan,
)
from lkb.method_governance import (
    approve_method,
    deprecate_method,
    get_proposal,
    list_proposals,
...
from lkb.method_coverage import MethodCoverageEvaluator
...
class TestVersionManagement:
    def test_parse_valid_semver(self) -> None:
        from lkb.method_library import _parse_semver
