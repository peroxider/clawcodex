...
``clawcodex_ext/intent_forecast/focus.py`` at Phase 2 publish time.

Phase 3 may replace ``compute_workspace_focuses`` with a Protocol-based
implementation satisfying
``extensions.orchestrator_runtime.protocols.IntentFocus``.
"""
